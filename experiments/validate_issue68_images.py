#!/usr/bin/env python3
"""Validate the generated image set for issue #68."""
...
MIN_BYTES = 500_000
MAX_BYTES = 1_500_000
SIZE_TOLERANCE = 25_000
FILES = (
    "mev-sandwich-frontrunning-mempool.png",
    "mev-sandwich-frontrunning-mempool-dark-forest.png",
    "mev-sandwich-frontrunning-mempool-sandwich-math.png",
    "mev-sandwich-frontrunning-mempool-taxonomy.png",
    "mev-sandwich-frontrunning-mempool-defenses.png",
)
...
def main() -> None:
    for filename in FILES:
        ...
        assert MIN_BYTES <= file_size <= MAX_BYTES + SIZE_TOLERANCE, (
            f"{filename}: expected approximately {MIN_BYTES:,}-{MAX_BYTES:,} bytes, "
            f"got {file_size:,}"
        )
