#!/usr/bin/env python3
"""Validate the generated image set for issue #53."""
...
MAX_BYTES = 1_500_000
FILES = (
    "volatility-targeting-garch-strategy.png",
    "volatility-targeting-garch-strategy-vol-targeting.png",
    "volatility-targeting-garch-strategy-forecast-contest.png",
    "volatility-targeting-garch-strategy-forecast-eval.png",
    "volatility-targeting-garch-strategy-walk-forward.png",
)
