// Command create_issue94_contact_sheet creates visual review evidence for issue 94.
package main
...
var names = []string{
	"uniswap-v3-lp-strategies-hedging.png",
	"uniswap-v3-lp-strategies-hedging-range-from-vol.png",
	"uniswap-v3-lp-strategies-hedging-rebalance-band.png",
	"uniswap-v3-lp-strategies-hedging-delta-hedge.png",
	"uniswap-v3-lp-strategies-hedging-jit-liquidity.png",
}
...
func main() {
	...
	out, err := os.Create("docs/screenshots/issue94-contact-sheet.png")
	if err != nil {
		panic(err)
	}
